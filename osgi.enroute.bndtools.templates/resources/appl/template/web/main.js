...
(function() {
	...
	var MODULE = angular.module('{{projectName}}',
			[ 'ngRoute', 'ngResource' ]);

	MODULE.config( function($routeProvider) {
		$routeProvider.when('/', { controller: mainProvider, templateUrl: '/{{projectName}}/main/htm/home.htm'});
		$routeProvider.when('/about', { templateUrl: '/{{projectName}}/main/htm/about.htm'});
