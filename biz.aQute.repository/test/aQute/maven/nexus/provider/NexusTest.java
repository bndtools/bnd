...
public class NexusTest extends TestCase {
	...
	public void testTravers() throws Exception {
		...
		Nexus nexus = new Nexus(new URI("https://oss.sonatype.org/service/local/repositories/orgosgi-1083"), client);
	...
	public void testSign() throws Exception {
		Signer signer = new Signer("jokulsarlon6128", null);
		File in = IO.getFile("testresources/nexus/testfile.txt");
		byte[] sign = signer.sign(in);
		assertNotNull(sign);
	}
}
