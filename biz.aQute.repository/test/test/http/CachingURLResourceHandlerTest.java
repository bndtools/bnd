...
public class CachingURLResourceHandlerTest extends TestCase {
	...
	public void testLoadFromCache() throws Exception {
		CachingURLResourceHandle handle = new CachingURLResourceHandle("http://localhost:18083/bundles/dummybundle.jar", "http://localhost:18083", new File("testdata/httpcache/1"), CachingMode.PreferRemote);
		File result = handle.request();
		
		assertEquals(new File("testdata/httpcache/1/http%3A%2F%2Flocalhost%3A18083%2Fbundles/dummybundle.jar").getAbsolutePath(), result.getAbsolutePath());
	}
	
	public void testFailedLoadFromRemote() throws Exception {
		CachingURLResourceHandle handle = new CachingURLResourceHandle("http://localhost:18083/bundles/dummybundle.jar", "http://localhost:18083", new File("testdata/httpcache/2"), CachingMode.PreferRemote);
	...
	public void testLoadFromRemote() throws Exception {
		CachingURLResourceHandle handle = new CachingURLResourceHandle("http://localhost:18083/bundles/dummybundle.jar", "http://localhost:18083", new File("testdata/httpcache/3"), CachingMode.PreferRemote);
	...
	public void testRemoteUnmodifiedETag() throws Exception {
		...
		CachingURLResourceHandle handle = new CachingURLResourceHandle("http://localhost:18083/bundles/dummybundle.jar", "http://localhost:18083", new File("testdata/httpcache/4"), CachingMode.PreferRemote);
	...
	public void testRemoteModifiedETag() throws Exception {
		...
		CachingURLResourceHandle handle = new CachingURLResourceHandle("http://localhost:18083/bundles/dummybundle.jar", "http://localhost:18083", new File("testdata/httpcache/5"), CachingMode.PreferRemote);
	...
	public void testPreferCacheEmptyCache() throws Exception {
		...
		CachingURLResourceHandle handle = new CachingURLResourceHandle("http://localhost:18083/bundles/dummybundle.jar", "http://localhost:18083", new File("testdata/httpcache/6"), CachingMode.PreferCache);
		NanoHTTPD httpd = new NanoHTTPD(18083, new File("testdata/http"));
		try {
			File result = handle.request();
			assertEquals(cached, result);
	...
	public void testPreferCache() throws Exception {
		...
		CachingURLResourceHandle handle = new CachingURLResourceHandle("http://localhost:18083/bundles/dummybundle.jar", "http://localhost:18083", new File("testdata/httpcache/7"), CachingMode.PreferCache);
		NanoHTTPD httpd = new NanoHTTPD(18083, new File("testdata/http"));
		try {
			File result = handle.request();
			assertEquals(cached, result);
