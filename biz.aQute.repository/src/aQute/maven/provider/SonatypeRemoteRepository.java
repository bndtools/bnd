...
public class SonatypeRemoteRepository extends MavenBackingRepository {
	private static final int				STAGING_DELAY		= 60 * 60 * 1000;										// 1
																														// hour

	private final static Logger				logger				= LoggerFactory.getLogger(SonatypeRemoteRepository.class);
	...
	public SonatypeRemoteRepository(File root, HttpClient client, String base, Reporter reporter) throws Exception {
