...
class R5Resource extends BaseResource {
	...
	private R5Resource(String baseUrl, Collection< ? extends Capability> capabilities,
			Collection< ? extends Requirement> requires) {
		super(baseUrl);
	...
	public static class Builder {
		...
		public R5Resource build() {
			return new R5Resource(baseUrl, Collections.unmodifiableList(capabilities),
	...
	public String toString() {
		...
		builder.append("Resource [capabilities=").append(capabilities).append(", requirements=").append(requires)
				.append("]");
