 ...
 * and a basic local cache. <p> <h2>Properties</h2> <ul> <li><b>locations:</b>
 * comma-separated list of index URLs. <b>NB:</b> surround with single
 * quotes!</li> <li><b>name:</b> repository name; defaults to the index URLs.
 ...
 * <li><b>location:</b> (deprecated) alias for "locations". </ul> <p>
 * <h2>Example</h2> <pre> -plugin:
 * aQute.lib.repository.FixedIndexedRepo;locations='http://www.example.com/
 * repository.xml';cache=${workspace}/.cache </pre> @author Neil Bartlett
 */
