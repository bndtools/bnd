...
public class LocaleHelper {
	 ...
	 *
	 * @param jar
	 *            the jar containing the localization file, must not be {@code null}
	 * @param locale
	 *            the default locale for this helper, must not be {@code null}
	 * @param basePath
	 *            a path in the Jar to the localization property file without its
	 *            extension and its locale suffix, must not be {@code null}
	 * @return a {@code LocaleHelper} which contains localization data or
	 *         {@code null} if the localization property file is not found
	 */
	...
	/**
	 * If the argument is a variable, its corresponding value will be returned for
	 * the default locale of this helper instance. Otherwise, the argument is
	 * returned.
	 * <p>
	 * Values will be search from the most specific to the less specific locale
	 * including unlocalized (empty locale) value.
	 *
	 * @param variableOrValue
	 *            a variable (starting with '%') or a value, can be {@code null}
	...
	/**
	 * If the argument is a variable, its corresponding value will be returned for
	 * the specified locale. Otherwise, the argument is returned.
	 * <p>
	 * Values will be search from the most specific to the less specific locale
	 * including unlocalized (empty locale) value.
	 *
