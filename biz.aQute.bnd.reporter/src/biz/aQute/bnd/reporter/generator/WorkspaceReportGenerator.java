...
public final class WorkspaceReportGenerator extends ReportGenerator {
  ...
  @Override
  protected void extractMetadataFromPlugins(final Map<String, Object> metadata,
      final List<String> includes, final List<String> locales) {
  ...
  protected Set<String> getAllAvailableEntries() {
    return getPlugins(WorkspaceEntryPlugin.class).stream().map(p -> p.getEntryName())
