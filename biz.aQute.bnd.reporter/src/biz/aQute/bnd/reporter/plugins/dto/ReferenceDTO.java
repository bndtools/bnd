...
public class ReferenceDTO extends DTO {
	 ...
	 * declare a name for the reference.
	 */
	public String name;
	 ...
	 * <p>
	 * This is declared in the {@code interface} attribute of the {@code reference}
	 * element.
	 */
	 ...
	 * element. This must be the "static" policy if the component description does
	 * not declare a policy for the reference.
	 */
	 ...
	 * {@code reference} element. This must be the "reluctant" policy option if the
	 ...
	 * <p>
	 * This is declared in the {@code updated} attribute of the {@code reference}
	 * element. This must be {@code null} if the component description does not
	 ...
	 * element. This must be the "bundle" scope if the component description does
