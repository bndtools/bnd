...
public class ManifestImportDeserializerPlugin implements ReportImportDeserializerPlugin {

	static private final String[] _ext = { "mf" };
	...
	public Object deserialyze(final InputStream input) throws Exception {
		...
		for (final Object key : manifest.getMainAttributes().keySet()) {
			...
			for (final Entry<String, ? extends Map<String, String>> entry : param.asMapMap().entrySet()) {
				...
				for (final Entry<String, String> entryAttr : entry.getValue().entrySet()) {
