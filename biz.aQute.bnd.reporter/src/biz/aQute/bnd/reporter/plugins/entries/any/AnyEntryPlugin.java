...
/**
 * This plugin allows the user to define a report entry in a bnd property file. The user must
 * provide the {@link AnyEntryPlugin#KEY_PROPERTY} and the {@link AnyEntryPlugin#VALUE_PROPERTY}
 * properties to be effective. The {@link AnyEntryPlugin#KEY_PROPERTY} will then be used as the
 * entry name in the report.
 */
