 ...
 * {@link CodeSnippetPlugin#PATH_PROPERTY} to specify the folder from which snippets are looked up.
 * By default, snippets are read from {testClasspath}/examples directory.
 */
