...
class Snippet {
  ...
  public Snippet(final String groupName, final CodeSnippetGroupDTO dto) {
    this(Objects.requireNonNull(groupName, "groupName"), Objects.requireNonNull(dto, "dto"), null,
        null);
  }
  ...
  private Snippet(final String groupName, final CodeSnippetGroupDTO groupDto,
      final String parentGroup, final CodeSnippetProgramDTO programDto) {
    super();
