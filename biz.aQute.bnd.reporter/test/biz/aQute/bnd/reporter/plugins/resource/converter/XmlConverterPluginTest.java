...
public class XmlConverterPluginTest {
  ...
  public void testXmlConvertion() throws Exception {
    ...
    entry = new XmlConverterPlugin()
        .extract(IO.stream(Paths.get("testresources/xmlConverter/complex.xml")));
    ...
    assertEquals(
        new String(IO.read(IO.stream(Paths.get("testresources/xmlConverter/xmlJsonResult.json")))),
        new String(out.toByteArray()));
    assertArrayEquals(new String[] {"xml"}, new XmlConverterPlugin().getHandledExtensions());
  }
}
