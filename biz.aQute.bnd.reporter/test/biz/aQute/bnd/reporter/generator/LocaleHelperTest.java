...
public class LocaleHelperTest {
	...
	public void testEmpty() {
		LocaleHelper h = LocaleHelper.empty();
	...
	public void testUnlocalized() {
		...
		LocaleHelper h = LocaleHelper.get(jar, "", "ln/bundle");
