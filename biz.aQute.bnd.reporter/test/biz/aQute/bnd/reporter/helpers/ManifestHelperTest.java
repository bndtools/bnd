...
public class ManifestHelperTest {
	...
	public void testWithoutLocalization() {
		...
		final ManifestHelper h = ManifestHelper.get(jar, "");
	...
	public void testWithLocalizationDefault() {
		...
		jar.setManifest(manifest);
		final ManifestHelper h = ManifestHelper.get(jar, "");
		final ManifestHelper hen = ManifestHelper.get(jar, "en");
		...
		assertEquals(0, hen.getHeader("Notfound", false).keySet().size());
