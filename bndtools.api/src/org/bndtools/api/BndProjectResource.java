...
public class BndProjectResource {
	...
	public BndProjectResource(URL url, Map<String, String> replaceRegularExpressions) {
		super();
		this.url = url;
	...
	public void setReplaceRegularExpressions(Map<String, String> replaceRegularExpressions) {
		this.replaceRegularExpressions = replaceRegularExpressions;
	}
}
