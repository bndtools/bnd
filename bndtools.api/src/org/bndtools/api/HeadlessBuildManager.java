...
public interface HeadlessBuildManager {
	 ...
	 * 
	 * @param plugins
	 *            the plugins to involve in adding/removing the headless build
	 *            of a project. Usually only the plugins that are enabled
	 *            through the preferences should be involved: it is strongly
	 *            advised to get these through
	 *            {@link BndPreferences#getHeadlessBuildPluginsEnabled(HeadlessBuildPluginTracker, Set)}
