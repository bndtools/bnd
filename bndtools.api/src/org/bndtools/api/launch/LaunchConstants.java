...
public interface LaunchConstants {
	...
	String	LAUNCH_ID_OSGI_NATIVE		= "bndtools.launch.bnd.NativeBndLaunchDelegate";
	String	LAUNCH_ID_OSGI_RUNTIME		= "bndtools.launch.OSGiRunLaunchDelegate";
	String	LAUNCH_ID_OSGI_JUNIT		= "bndtools.launch.OSGiJUnitLaunchDelegate";
