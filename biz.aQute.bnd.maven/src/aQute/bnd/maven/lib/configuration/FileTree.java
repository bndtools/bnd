...
public class FileTree {
    ...
    /**
     * Can be used by subclasses to add specific files to the return value of {@link #getFiles(File, String)}.
     *
     * @param file A file to include in the return value of {@link #getFiles(File, String)}.
     */
    ...
    /**
     * Return a list of files using the specified baseDir and the configured include and exclude Ant-style glob
     * expressions.
     *
     * @param baseDir The base directory for locating files.
     * @param defaultIncludes The default include patterns to use if no include patterns were configured.
