...
public class MetadataParser {
	...
	public static class Metadata extends DTO {
		...
		public Tag toTag() {
			Tag top = new Tag("metadata", "modelVersion", modelVersion);
			new Tag(top, "groupId").addContent(group);
			new Tag(top, "artifactId").addContent(artifact);
			new Tag(top, "lastUpdated", timestamp.format(new Date(lastUpdated)));
			return top;
		}
	...
	public static class ProgramMetadata extends Metadata {
		...
		public Tag toTag() {
			...
			Tag versionsTag = new Tag(top, "versions");
	...
	public static class RevisionMetadata extends Metadata {
		...
		public Tag toTag() {
			Tag top = super.toTag();
			new Tag(top, "version", version);
			Tag snapshot = new Tag(top, "snapshot");
