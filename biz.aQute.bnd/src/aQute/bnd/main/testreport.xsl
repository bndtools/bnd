	...
	<xsl:template match="/">
		<html>
			...
			<body style="width:800px">
				...
				<table width="100%">
					<tr>
						<th width="15px"><img src="http://www.osgi.org/www/colorball.png" title="Status. red=bad, orange=almost good, green is perfect"/></th>
						<th>Test</th>
						<th>Failures</th>
						<th>Error</th>
						<th>Info</th>
					...
					<xsl:for-each select="/testsuite/testcase">
						...
						<tr>
							...
							<td>
								<xsl:if test="failure or error">
									<img src="http://www.osgi.org/www/info.png" onclick="toggle('{@name}')" title="Show Exceptions"/>
								</xsl:if>
							</td>
						</tr>
						...
						<xsl:for-each select="//coverage/class">
							...
							<xsl:for-each select="method">
								...
								<tr>
									...
									<td>
										<xsl:if test="ref">
											<img src="http://www.osgi.org/www/info.png" onclick="toggle('{@pretty}')" title="Show/Hide Callers"/>
										</xsl:if>
									</td>
								</tr>
							</xsl:for-each>
