...
public abstract class FacadeUtil implements IExecutableExtensionFactory, IExecutableExtension {
	...
	public FacadeUtil() {
		if (context == null) {
			Bundle bundle = FrameworkUtil.getBundle(FacadeUtil.class);
			if (bundle != null)
	...
	public static MethodHandle lookup(Class target, String name, Class... parameterTypes) {
		return null;
	}
	...
	public Object invokeReturn(FE f) {
		return null;
	}

	public Object invokeVoid(CE f) {
		return null;
	}

	protected abstract Object createDelegate(Function<Object, Supplier<Object>> bindFunction);
	...
	private void fatal(String message, Object... data) {
		String msg = String.format("""
			...
			""", FacadeUtil.class.getSimpleName(), IExecutableExtension.class.getName());
