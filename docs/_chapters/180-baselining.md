...
To enable baselining for versions in the range `[0.1.0, 1.0.0)`, use the `includezeromajor` attribute in the [`-diffpackages` instruction](../instructions/diffpackages.html):
