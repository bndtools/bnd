...
function initSearch() {
  ...
  request.open('GET', '/releases/7.3.0/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/releases/7.3.0/assets/css/just-the-docs-' + theme + '.css');
}
...
jtd.onReady(function () {
  ...
  fetch("/releases/7.3.0/index.json")
