...
class BundleTaskConvention {
  ...
  public void setBndfile(String file) {
    getBndfile().value(layout.projectDirectory.file(file))
  }
  ...
  public void setBndfile(Object file) {
    getBndfile().set(task.project.file(file))
  }
  ...
  public void setSourceSet(SourceSet sourceSet) {
    allSource.setFrom(providers.provider({ -> sourceSet.allSource.srcDirs }))
    jarLibraryElements(task, sourceSet.compileClasspathConfigurationName)
