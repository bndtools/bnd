...
public interface Meta {
	...
	@interface OCD {
		 ...
		 * name that us un-camel cased to make it more readable. @return The
		 ...
		 * in the Designate element. Reported as an error. @return the id
		 */
		String id() default NULL;

		/**
		 * The localization prefix. The default localization prefix is the name
		 * of the class with a $ separator for nested classes. @return the
		 * localization prefix.
		 */
		String localization() default NULL;

		/**
		 * A description for this ocd. The default is empty. @return the
		 * description
		 */
	...
	@interface AD {
		/**
		 * A description of the attribute. Default is empty. @return The
		 ...
		 * the method name. @return the name
		 */
		String name() default NULL;
		 ...
		 * runtime annotation so the runtime can find the proper key. @return
		 * the id
		 */
		String id() default NULL;
		 ...
		 * Unrecognized types are defaulted to String. @return the type to be
		 * used.
		 */
		 ...
		 * be used as a separator to split the line. @return the cardinality of
		 * the attribute
		 */
		 ...
		 * type before comparison takes place. @return the min value
		 */
		String min() default NULL;

		/**
		 * The maximum value. This string must be converted to the attribute
		 * type before comparison takes place. @return the max value
		 */
		String max() default NULL;

		/**
		 * The default value. This value must be converted to the return type of
		 * the attribute. For multi valued returns use the | as
		 * separator. @return the default value
		 */
		 ...
		 * they are set of course). @return the option labels
		 */
		String[]optionLabels() default NULL;

		/**
		 * The values of options. If not set and the return type is an enum
		 * class then the values will be derived from this return type. @return
		 * the option labels
		 */
