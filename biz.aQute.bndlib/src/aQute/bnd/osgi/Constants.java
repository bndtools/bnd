...
public interface Constants {
	...
	String								CONTRACT_EMULATION							= "-contract.emulation";
	@Deprecated
	...
	String								options[]									= {
		...
		REPRODUCIBLE, INCLUDEPACKAGE, CDIANNOTATIONS, CONTRACT_EMULATION
	...
	String[]							BUNDLE_SPECIFIC_HEADERS						= new String[] {
		...
		DSANNOTATIONS, SERVICE_COMPONENT, SIGNATURE_TEST, METATYPE_ANNOTATIONS, CDIANNOTATIONS
	};
