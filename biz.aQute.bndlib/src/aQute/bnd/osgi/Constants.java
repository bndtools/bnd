...
public interface Constants {
	...
	String							options[]									= {
			...
			INVALIDFILENAMES, FIXUPMESSAGES, PRIVATEPACKAGE, CONDITIONALPACKAGE
																				};
	...
	String[]						BUNDLE_SPECIFIC_HEADERS						= new String[] {
			...
			IMPORT_PACKAGE, EXPORT_PACKAGE, DYNAMICIMPORT_PACKAGE, FRAGMENT_HOST, REQUIRE_BUNDLE, PRIVATE_PACKAGE, PRIVATEPACKAGE,
