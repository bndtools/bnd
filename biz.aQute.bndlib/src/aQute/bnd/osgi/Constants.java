...
public interface Constants {
	 ...
	 */
	String		DUP_OVERWRITE								= "dup_overwrite:";
	String		DUP_MERGE									= "dup_merge:";
	String		DUP_ERROR									= "dup_error:";
	String		DUP_WARNING									= "dup_warning:";
	String		DUP_SKIP									= "dup_skip:";
	...
	Set<String>	directives									= Sets.of(SPLIT_PACKAGE_DIRECTIVE, NO_IMPORT_DIRECTIVE,
		...
		AUGMENT_REQUIREMENT_DIRECTIVE, DUP_OVERWRITE, DUP_MERGE, DUP_ERROR, DUP_WARNING, DUP_SKIP);
