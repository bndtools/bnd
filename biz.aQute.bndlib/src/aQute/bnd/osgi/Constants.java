...
public interface Constants {
	...
	String							FIXUPMESSAGES_ERROR_ATTRIBUTE				= "error";
	String							FIXUPMESSAGES_WARNING_ATTRIBUTE				= "warning";
	String							FIXUPMESSAGES_IGNORE_ATTRIBUTE				= "ignore";
	...
	String							directives[]								= {
			...
			FILTER_DIRECTIVE, FIXUPMESSAGES_ERROR_ATTRIBUTE, FIXUPMESSAGES_IGNORE_ATTRIBUTE,
			FIXUPMESSAGES_RESTRICT_DIRECTIVE, FIXUPMESSAGES_WARNING_ATTRIBUTE
