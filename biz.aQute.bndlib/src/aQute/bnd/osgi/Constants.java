...
public interface Constants {
	...
	String							options[]									= {
			...
			STRICT, DIFFIGNORE, DIFFPACKAGES, CONTRACT, NOBUILDINCACHE, EXTENSION, NOJUNIT, NOJUNITOSGI,
			...
			RUNPROVIDEDCAPABILITIES, WORKINGSET, RUNSTORAGE, REPRODUCIBLE, REPORT_BUNDLE, REPORT_PROJECT, REPORT_WORKSPACE,
			REPORT_MODEL_BUNDLE, REPORT_MODEL_PROJECT, REPORT_MODEL_WORKSPACE
