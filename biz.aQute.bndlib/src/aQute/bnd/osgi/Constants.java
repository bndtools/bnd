...
public interface Constants {
	...
	String				OSGI_SYNTAX_HEADERS[]						= {
		...
		BUNDLE_LICENSE, BUNDLE_NATIVECODE, BUNDLE_SYMBOLICNAME, BUNDLE_UPDATELOCATION, DYNAMICIMPORT_PACKAGE,
		EXPORT_PACKAGE, EXPORT_SERVICE, FRAGMENT_HOST, IMPORT_PACKAGE, IMPORT_SERVICE, LAUNCHER_PLUGIN,
		PROVIDE_CAPABILITY, REQUIRE_BUNDLE, REQUIRE_CAPABILITY, SERVICE_COMPONENT, PRIVATE_PACKAGE, IGNORE_PACKAGE
	};
