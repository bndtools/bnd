...
public interface Constants {
	...
	String				OSGI_SYNTAX_HEADERS[]						= {
		BUNDLE_ACTIVATIONPOLICY, BUNDLE_ACTIVATOR, BUNDLE_BLUEPRINT, BUNDLE_CLASSPATH, BUNDLE_DEVELOPERS, BUNDLE_ICON,
		BUNDLE_LICENSE, BUNDLE_NATIVECODE, BUNDLE_SCM, BUNDLE_SYMBOLICNAME, BUNDLE_UPDATELOCATION,
		DYNAMICIMPORT_PACKAGE, EXPORT_PACKAGE, EXPORT_SERVICE, FRAGMENT_HOST, IMPORT_PACKAGE, IMPORT_SERVICE,
		LAUNCHER_PLUGIN, PROVIDE_CAPABILITY, REQUIRE_BUNDLE, REQUIRE_CAPABILITY, SERVICE_COMPONENT, PRIVATE_PACKAGE,
		IGNORE_PACKAGE
	};
	...
	String				SHADE										= "-shade";
	String				SHADE_PREFIX_DIRECTIVE						= "prefix:";
	...
	String				options[]									= {
		...
		RUNFRAMEWORKRESTART, NOIMPORTJAVA, SHADE
	...
	String[]			BUNDLE_SPECIFIC_HEADERS						= new String[] {
		INCLUDE_RESOURCE, INCLUDERESOURCE, BUNDLE_ACTIVATOR, BUNDLE_CLASSPATH, BUNDLE_NAME, BUNDLE_NATIVECODE,
		BUNDLE_SYMBOLICNAME, IMPORT_PACKAGE, EXPORT_PACKAGE, DYNAMICIMPORT_PACKAGE, FRAGMENT_HOST, REQUIRE_BUNDLE,
		PRIVATE_PACKAGE, PRIVATEPACKAGE, INCLUDEPACKAGE, EXPORT_CONTENTS, TESTCASES, NOMANIFEST, WAB, WABLIB,
		REQUIRE_CAPABILITY, PROVIDE_CAPABILITY, DSANNOTATIONS, SERVICE_COMPONENT, SIGNATURE_TEST, METATYPE_ANNOTATIONS,
	...
	String				directives[]								= {
		...
		BNDDRIVER_OSMORC, AUGMENT_CAPABILITY_DIRECTIVE, AUGMENT_REQUIREMENT_DIRECTIVE, SHADE_PREFIX_DIRECTIVE
