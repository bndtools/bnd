...
public interface Constants {
	...
	String		PROPERTYCONFLICTS							= "-propertyconflicts";
	...
	Set<String>	options										= Sets.of(BASELINE, BUILDPATH, BUMPPOLICY, CONDUIT,
		...
		BASELINEINCLUDEZEROMAJOR, INCLUDERESOURCE, MAKE, MANIFEST, NOEXTRAHEADERS, NOUSES, NOBUNDLES, PEDANTIC, PROPERTYCONFLICTS, PLUGIN, POM, PROVIDER_POLICY,
