...
public interface Constants {
	...
	Set<String> SET_COMPONENT_DIRECTIVES = new HashSet<String>(Arrays.asList(componentDirectives));
	...
	Set<String> SET_COMPONENT_DIRECTIVES_1_2 = new HashSet<String>(Arrays.asList(COMPONENT_GREEDY));
