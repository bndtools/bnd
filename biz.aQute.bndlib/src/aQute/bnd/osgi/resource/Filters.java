...
public class Filters {
	 ...
	 * [1.0,2.0)} generates {@code (&(version>=1.0)(!(version>=2.0))} @param
	 * range @return The generated filter. @throws IllegalArgumentException If
	 ...
	 * {@code (&(bundle-version>=1.0)(!(bundle-version>=2.0))}. @param
	 * range @param versionAttr @return The generated filter @throws
