...
public class Jar implements Closeable {
	 ...
	 * </p>
	 * <p>
	 * It's better to use {@link Version#fromManifest(Manifest, boolean)}. The
	 * difference is that that method does check whether the header value is a
	 * valid version, while this method does not.
	 * </p>
	 * 
