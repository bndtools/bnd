...
public class ReferenceDTO extends DTO {
	 ...
	 * element. This must be the default policy if the component description does
	 ...
	 * element. This must be the default scope if the component description does not
	 * declare a scope for the reference.
	 */
	public String	scope;
}
