...
public interface CommandPlugin {
	 ...
	 * order of declaration. @param project The project for which the command
	 * runs @param command the command name
	 */
	void before(Project project, String command);

	/**
	 * Is run after a command is executed. These plugins are called in the
	 * reverse order of declaration. @param project The project for which the
	 * command runs @param command the command name
	 */
