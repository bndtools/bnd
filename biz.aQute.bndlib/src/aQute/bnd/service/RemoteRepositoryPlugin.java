...
public interface RemoteRepositoryPlugin extends RepositoryPlugin {
	 ...
	 * should always return the same result as {@link
	 * RepositoryPlugin#get(String, aQute.bnd.version.Version, Map)} @param bsn
	 * the bsn of the revision @param version the version of the revision @param
	 * strategy strategy @param properties any properties @return @throws
	 * Exception
	 */
