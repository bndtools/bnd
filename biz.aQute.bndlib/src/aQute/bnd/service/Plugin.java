...
public interface Plugin {
	 ...
	 * are given to the plugin to use. @param map attributes and directives for
	 * this plugin's clause @throws Exception
	 */
	 ...
	 * report all errors and warnings to this reporter. @param processor
	 */
