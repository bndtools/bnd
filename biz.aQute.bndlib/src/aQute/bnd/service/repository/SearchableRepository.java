...
public interface SearchableRepository {
	 ...
	 * set is owned by the caller and may be modified. <p/> The @{code
	 * includeDependencies} parameter indicates that if possible any mandatory
	 * compile and runtime dependencies should be added to the result
	 * set. @param url the dropped url @param includeDependencies Include any
	 * dependent revisions @return null or the modifiable set of associated
	 ...
	 * items are not automatically added to the repository. @param query The
	 * query syntax @return a set of resource descriptors. @throws Exception
	 */
	 ...
	 * ignored. True must be returned if this descriptor was accepted. @param
	 * resource the descriptor to add @return true if added, false if
	 ...
	 * all revisions that have a matching capability. <p/> The @{code
	 * includeDependencies} parameter indicates that if possible any mandatory
	 * compile and runtime dependencies should be added to the result
	 * set. @param requirement The requirement to match @param
	 * includeDependencies Include any dependent revisions @return the set of
	 * resource descriptors that match, potentially empty @throws Exception
	 */
	 ...
	 * repository. @param searchString A search string, or null for general
	 * browsing @return A URL that may be opened in a web browser, or null if
	 * the repository does not support web browsing. @throws Exception
	 */
