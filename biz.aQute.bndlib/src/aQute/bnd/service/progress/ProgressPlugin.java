...
/**
 * A plugin for reporting progress on long-running jobs. @author Neil Bartlett
 * <njbartlett@gmail.com>
 */
public interface ProgressPlugin {

	/**
	 * Start a task with the specified name. @param name The name of the task --
	 * must not be null. @param size The expected size of the task, or -1 if not
	 * known in advance. @return A handle for the ongoing task.
	 */
	...
	static interface Task {
		 ...
		 * work should be performed in the task. @param message A message
		 * associated with the completion of the task; may be null. @param e An
		 * exception thrown by the task; may be null;
		 */
