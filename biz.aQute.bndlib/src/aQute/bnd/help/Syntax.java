...
public class Syntax implements Constants {
	...
	static final Syntax[]					syntaxes				= new Syntax[] {
																			...
																			new Syntax(SUB,
																					...
																					null),
																			new Syntax(REPORT,
					"Include generated reports into the Jar. The jar metadata will be extracted and converted to an XML representation, then the provided XSLT will be apply in order. Files can also be included into the report.",
					REPORT + ": outputReport.html;templates=toHtml.xslt;includes=@META-INF/maven/pom.xml", null, null),
