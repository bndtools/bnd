...
public class Syntax implements Constants {
	...
	static final Syntax[] syntaxes = new Syntax[] {
			...
			new Syntax(BUNDLE_DEVELOPERS, "Defines the primary developers of this bundle",
					BUNDLE_DEVELOPERS
							+ ": Peter.Kriens@aQute.biz;name='Peter Kriens Ing';organization=aQute;organizationUrl='http://www.aQute.biz';roles=ceo;timezone=+1",
					null, null),
			new Syntax(BUNDLE_CONTRIBUTORS, "Defines the people that contrbuted to this bundle",
					BUNDLE_CONTRIBUTORS
							+ ": Peter.Kriens@aQute.biz;name='Peter Kriens Ing';organization=aQute;organizationUrl='http://www.aQute.biz';roles=ceo;timezone=+1",
					null, null,
			...
			new Syntax(BUNDLE_NAME,
					"The " + BUNDLE_NAME + " header will be derived from the " + BUNDLE_SYMBOLICNAME
			...
			new Syntax(MAKE,
					...
					new Syntax("type", "Type name for plugin.", "type=bnd", "bnd", null), new Syntax("recipe",
			...
			new Syntax(RUNPROGRAMARGS, "Additional arguments for the program invokation.",
