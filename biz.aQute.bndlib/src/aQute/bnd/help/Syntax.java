...
public class Syntax implements Constants {
	...
	static final Syntax[]					syntaxes				= new Syntax[] {
																			new Syntax(".bnd",
																					...
																					null, null, null, new Syntax("build-deps",
																					...
																					new Syntax("settings.json",
																							...
																							new Syntax(
																											"id",
																											"The public key for this machine",
																											null,
																											null,
																											null),
																							new Syntax(
																											"secret",
																											"The private key for this machine",
																											null,
																											null,
																											null)), new Syntax("caches/shas",
																			...
																			new Syntax(BUNDLE_CATEGORY,
																					...
																					BUNDLE_CATEGORY + ": test",
																					"osgi,test,game,util,eclipse,netbeans,jdk,specification",
																					null),
																			new Syntax(BUNDLE_CLASSPATH,
																					"The " + BUNDLE_CLASSPATH
																					...
																					BUNDLE_CLASSPATH
																							+ ": /lib/libnewgen.so, .",
																					null, Verifier.PATHPATTERN),
																			new Syntax(BUNDLE_CONTACTADDRESS,
																					"The " + BUNDLE_CONTACTADDRESS
																							+ " header provides the contact address of the vendor.",
																					BUNDLE_CONTACTADDRESS
																							+ ": 2400 Oswego Road, Austin, TX 74563",
																					null, null),
																			new Syntax(BUNDLE_DEVELOPERS,
																					...
																					null, null),
																			new Syntax(BUNDLE_CONTRIBUTORS,
																					...
																					new Syntax("name",
																							...
																							"name='Peter Kriens'", null,
																							null),
																					new Syntax("organization",
																							"The display name of organization that employs the developer",
																							"organization='aQute'",
																							null, null),																																																																																																																//
																					new Syntax("roles",
																							"Roles played by the developer in this bundle's project (see Maven)",
																							"roles=ceo", null, null),																																																																																																													//
																					new Syntax("timezone",
																							"Timezone in offset of UTC this developer usually resides in",
																							"timezone+2", null, null),																																																																																																													//
																					new Syntax("organizationUrl",
																							"The URL of the developer's organization",
																							"organizationURL='http://www.aQute.biz'",
																							null, null)),
																			new Syntax(BUNDLE_COPYRIGHT,
																					"The " + BUNDLE_COPYRIGHT
																							+ " header contains the copyright specification for this bundle.",
																					BUNDLE_COPYRIGHT
																							+ ": OSGi (c) 2002",
																					null, null),
																			new Syntax(BUNDLE_DESCRIPTION,
																					"The " + BUNDLE_DESCRIPTION
																							+ " header defines a short description of this bundle.",
																					BUNDLE_DESCRIPTION
																							+ ": Ceci ce n'est pas une bundle",
																					null, null),
																			...
																			new Syntax(BUNDLE_LICENSE,
																					...
																					Pattern.compile(
																							"(" + Verifier.URLPATTERN
																									+ "|<<EXTERNAL>>)"),
																					new Syntax(DESCRIPTION_ATTRIBUTE,
																							"Human readable description of the license.",
																							DESCRIPTION_ATTRIBUTE
																									+ "=\"Describe the license here\"",
																							null, Verifier.ANYPATTERN),
																					new Syntax(LINK_ATTRIBUTE, "", "",
																							null, Verifier.URLPATTERN)),
																			new Syntax(BUNDLE_LOCALIZATION,
																					"The " + BUNDLE_LOCALIZATION
																			...
																			new Syntax(BUNDLE_NATIVECODE,
																					...
																					new Syntax(OSNAME_ATTRIBUTE,
																							...
																							OSNAME_ATTRIBUTE + "=MacOS",
																							Processor.join(
																									Verifier.OSNAMES,
																									","),
																							Verifier.ANYPATTERN),
																					new Syntax(OSVERSION_ATTRIBUTE,
																							"Operating System Version.",
																							OSVERSION_ATTRIBUTE
																									+ "=3.1",
																							null, Verifier.ANYPATTERN),
																					new Syntax(LANGUAGE_ATTRIBUTE,
																							"Language ISO 639 code.",
																							LANGUAGE_ATTRIBUTE + "=nl",
																							null, Verifier.ISO639),
																					new Syntax(PROCESSOR_ATTRIBUTE,
																							"Processor name.",
																							PROCESSOR_ATTRIBUTE
																									+ "=x86",
																							Processor.join(
																			...
																			new Syntax(
																					...
																					"The " + BUNDLE_REQUIREDEXECUTIONENVIRONMENT
																			...
																			new Syntax(BUNDLE_SYMBOLICNAME,
																					...
																					BUNDLE_SYMBOLICNAME
																							+ ": com.acme.foo.daffy;singleton:=true",
																					"${p}", Verifier.SYMBOLICNAME,
																			...
																			new Syntax(BUNDLE_VENDOR,
																					...
																					BUNDLE_VENDOR + ": OSGi Alliance",
																					null, null),

																			new Syntax(BUNDLE_VERSION,
																					"The " + BUNDLE_VERSION
																							+ " header specifies the version of this bundle.",
																					BUNDLE_VERSION
																							+ ": 1.23.4.build200903221000",
																					null, Verifier.VERSION),

																			new Syntax(DYNAMICIMPORT_PACKAGE,
																					"The " + DYNAMICIMPORT_PACKAGE
																					...
																					version, bundle_symbolic_name,
																					bundle_version),

																			new Syntax(EXPORT_PACKAGE,
																					"The " + EXPORT_PACKAGE
																					...
																					new Syntax(NO_IMPORT_DIRECTIVE,
																							"By default, bnd makes all exports also imports. Adding a "
																									+ NO_IMPORT_DIRECTIVE
																			...
																			new Syntax(FRAGMENT_HOST,
																					"The " + FRAGMENT_HOST
																							+ " header defines the host bundle for this fragment.",
																					FRAGMENT_HOST
																			...
																			new Syntax(IMPORT_PACKAGE,
																					...
																					IMPORT_PACKAGE
																							+ ": !com.exotic.*, com.acme.foo;vendor=ACME, *",
																					"${exported_packages}",
																					Verifier.WILDCARDNAMEPATTERN,
																					new Syntax(
																			...
																			new Syntax(FIXUPMESSAGES,
																					...
																					FIXUPMESSAGES
																							+ "='Version mismatch';replace:='************* ${@}';restrict:=error",
																					null, null),
																			new Syntax(INCLUDE,
																			...
																			new Syntax(NOEXTRAHEADERS,
																					"Do not generate housekeeping headers.",
																					NOEXTRAHEADERS + "=true",
																					"true,false",
																					Verifier.TRUEORFALSEPATTERN),
																			...
																			new Syntax(NOUSES,
																					"Do not calculate the "
																							+ USES_DIRECTIVE
																							+ " directive on exports.",
																					NOUSES + "=true", "true,false",
																					Verifier.TRUEORFALSEPATTERN),

																			new Syntax(NOEE,
																					"Do not calculate the osgi.ee name space Execution Environment from the class file version",
																					NOEE + "=true", "true,false",
																					Verifier.TRUEORFALSEPATTERN),
																			new Syntax(PEDANTIC,
																					"Warn about things that are not really wrong but still not right.",
																					PEDANTIC + "=true", "true,false",
																					Verifier.TRUEORFALSEPATTERN),

																			new Syntax(PLUGIN, "Define the plugins.",
																					PLUGIN + "=aQute.lib.spring.SpringComponent,aQute.lib.deployer.FileRepo;location=${repo}",
																					null, null),
																			new Syntax(PLUGINPATH,
																					"Define the plugins load path.",
																					PLUGINPATH
																							+ "=${workspace}/cnf/cache/plugins-2.2.0.jar",
																					null, null,
																					new Syntax(PLUGINPATH_URL_ATTR,
																			...
																			new Syntax(SERVICE_COMPONENT,
																					...
																					SERVICE_COMPONENT
																							+ "=com.acme.Foo?;activate='start'",
																					null, null),

																			new Syntax(POM, "Generate a maven pom.",
																					POM + "=true", "true,false",
																					Verifier.TRUEORFALSEPATTERN),

																			new Syntax(RELEASEREPO,
																					"Specifies to which repo the project should be released.",
																					RELEASEREPO + "=cnf", "${repos}",
																					null),
		...
		new Syntax(REPRODUCIBLE, "Use a fixed timestamp for all jar entries.", REPRODUCIBLE + "=true", "true,false",
			Verifier.TRUEORFALSEPATTERN),
																			...
																			new Syntax(SOURCES,
																					...
																					Verifier.TRUEORFALSEPATTERN),
																			new Syntax(SOURCEPATH,
																					"List of directory names that used to source sources for "
																							+ SOURCES + ".",
																					SOURCEPATH + ":= src, test", null,
																					null),
																			new Syntax(TESTPATH,
																					...
																					"-testpath=som.bundle.symbolicname;version=latest",
																					null, null),
																			new Syntax(TESTER,
    			...
    			new Syntax(REPORT_BUNDLE,
					...
					new Syntax("template:",
							"(Optional) Paths to a template file used to transform the extracted metadata.",
							"template:=bundle.xslt", null, null),
					new Syntax("<anyAttr>",
			...
			new Syntax(REPORT_PROJECT,
					...
					new Syntax("template:",
							"(Optional) Paths to a template file used to transform the extracted metadata.",
							"template:=project.xslt", null, null),
					new Syntax("<anyAttr>",
							"Arbitrary attributes that will be provided to the transformation process if any.",
							"param1=value", null, null)),
			new Syntax(REPORT_WORKSPACE,
					...
					new Syntax("template:",
							"(Optional) Paths to a template file used to transform the extracted metadata.",
							"template:=workspace.xslt", null, null),
					new Syntax("<anyAttr>",
							"Arbitrary attributes that will be provided to the transformation process if any.",
							"param1=value", null, null)),
			new Syntax(REPORT_MODEL_BUNDLE, "Configure the bundle metadata extraction.",
					...
					new Syntax("imports",
							...
							"imports='@META-INF/maven/pom.xml,bnd.bnd:config:properties'", null, null),
					new Syntax("locales",
							"A list of locales <language_COUNTRY_variant>. Used to extract the Jar metadata for different languages.",
							"locales='en,en_US,fr'", null, null),
					new Syntax("includes",
							"A list of plugin entry names to include into the extracted metadata. Default is all the declared plugins.",
							"includes='manifest,components'", null, null),
					new Syntax("excludes",
							"A list of plugin entry names to exclude from the extracted metadata. Default is empty.",
			...
			new Syntax(REPORT_MODEL_PROJECT, "Configure the project metadata extraction.",
					...
					new Syntax("imports", "Paths to files that must be imported into the extracted metadata."
							+ "The entry name and the format will be derived from the file name and its extension,"
							+ " but can be overridden with the syntax <path>:<parentName>:<type>",
							"imports='bnd.bnd:config:properties'", null, null),
					new Syntax("includes",
							"A list of plugin entry names to include in the extracted metadata. Default is all the declared plugins.",
							"includes='settings,contents'", null, null),
					new Syntax("excludes",
							"A list of plugin entry names to exclude from the extracted metadata. Default is empty.",
			...
			REPORT_MODEL_WORKSPACE + ": imports=build.bnd::properties,@<anyProp>='a value'", null, null,
					new Syntax("imports", "Paths to files that must be imported into the extracted metadata."
							+ "The entry name and the format will be derived from the file name and its extension,"
							+ " but can be overridden with the syntax <path>:<parentName>:<type>",
							"imports='build.bnd:config:properties'", null, null),
					new Syntax("includes",
							"A list of plugin entry names to include in the extracted metadata. Default is all the declared plugins.",
							"includes='settings,contents'", null, null),
					new Syntax("excludes",
					...
					new Syntax("@<anyProp>", "Arbitrary properties can be included in the extracted metadata.",
							"@oneProp=Rambo,@anotherProp=Titeuf", null, null)),
																			...
																			new Syntax(RUNSYSTEMPACKAGES,
																					...
																					RUNSYSTEMPACKAGES
																							+ "=com.acme.foo,javax.management",
																					null, null),
																			new Syntax(RUNBUNDLES,
																					"Add additional bundles, specified with their bsn and version like in "
																							+ BUILDPATH
																							+ ", that are started before the project is run.",
																					RUNBUNDLES
																							+ "=osgi;version=\"[4.1,4.2)\", junit.junit, com.acme.foo;version=project",
																					null, Verifier.SYMBOLICNAME,
																					path_version),
																			new Syntax(RUNPATH,
																					"Additional JARs for the VM path, can include a framework",
																					RUNPATH + "=org.eclipse.osgi;version=3.5",
																					null, null, path_version),
																			new Syntax(RUNVM,
																					...
																					RUNVM + "=-Xmax=30, secondOption=secondValue",
																					null, null),
																			new Syntax(RUNPROGRAMARGS,
																					"Additional arguments for the program invocation.",
																					RUNPROGRAMARGS
																							+ "=/some/file /another/file some_argument",
																					null, null),
