...
public interface Constants {
	...
	String								headers[]									= {
																					...
																					BUNDLE_COPYRIGHT,
																					BUNDLE_DESCRIPTION,
																					BUNDLE_DOCURL, BUNDLE_LOCALIZATION,
																					BUNDLE_NATIVECODE, BUNDLE_VENDOR,
																					BUNDLE_VERSION,
																					BUNDLE_LICENSE, BUNDLE_CLASSPATH,
																					SERVICE_COMPONENT, EXPORT_PACKAGE,
			IMPORT_PACKAGE,
	...
	String								options[]									= {BUILDPATH,
																					...
																					FAIL_OK, INCLUDE, INCLUDERESOURCE,
																					MAKE, MANIFEST, NOEXTRAHEADERS,
																					NOUSES, NOBUNDLES,
																					PEDANTIC, PLUGIN, POM,
																					PROVIDER_POLICY, REMOVEHEADERS,
																					RESOURCEONLY, SOURCES,
																					SOURCEPATH, SOURCES, SOURCEPATH,
			SUB, RUNBUNDLES, RUNPATH, RUNSYSTEMPACKAGES,
	...
	String[]							BUNDLE_SPECIFIC_HEADERS						= new String[] {
																					INCLUDE_RESOURCE, BUNDLE_ACTIVATOR,
																					...
																					PRIVATE_PACKAGE, EXPORT_CONTENTS,
																					TESTCASES, NOMANIFEST,
																					SIGNATURE_TEST, WAB, WABLIB,
			REQUIRE_CAPABILITY, PROVIDE_CAPABILITY, DSANNOTATIONS, SERVICE_COMPONENT};
	...
	String								directives[]								= {
																					...
																					INCLUDE_DIRECTIVE, USES_DIRECTIVE,
																					EXCLUDE_DIRECTIVE,
