...
public class Processor implements Reporter, Constants, Closeable {
     ...
     * @return
     */
    public static Map<String, String> doAttrbutes(Object[] attrs, Clazz clazz,
            Macro macro) {
        ...
        for (Object a : attrs) {
            ...
            int n = attr.indexOf("=");
            if (n > 0) {
                map.put(attr.substring(0, n), macro.process(attr
                        .substring(n + 1)));
            } else
    ...
    /**
     * Add an additional plugin that is always added to the plugins.
     * This safes you from going through the string based approach.
     */
