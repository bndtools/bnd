...
public class CalltreeTest extends TestCase {
    ...
    public void testCoverage() throws Exception {
        ...
        Map<Clazz.MethodDef, List<Clazz.MethodDef>> xref = Coverage
                .getCrossRef(testsuite, target);
        System.out.println(xref);
        
        List<Clazz.MethodDef> refs = xref.get(new Clazz.MethodDef(0, Resource.class
                .getName(), "write", "(Ljava/io/OutputStream;)V"));
        ...
        assertEquals( md.clazz, "test.CalltreeTest.Implements");
        assertEquals( md.name, "<implements>");
        assertEquals( md.descriptor, "()V");
               

        assertTrue(xref.containsKey(new Clazz.MethodDef(0, Analyzer.class
                .getName(), "analyze", "()V")));
        assertTrue(xref.containsKey(new Clazz.MethodDef(0, Builder.class
                .getName(), "build", "()LaQute/lib/osgi/Jar;")));
        assertTrue(xref.get(
                new Clazz.MethodDef(0, "aQute.lib.osgi.Builder", "build",
                        "()LaQute/lib/osgi/Jar;")).contains(
                new Clazz.MethodDef(0, "test.CalltreeTest", "testCoverage",
                        "()V")));
    ...
    public void testCatalog() throws Exception {
        ...
        Map<MethodDef, List<MethodDef>> xref = Coverage.getCrossRef(
                new ArrayList<Clazz>(), target);

        System.out.println(Processor.join(xref.keySet(), "\n"));

        assertTrue(xref.containsKey(new Clazz.MethodDef(0,
                "org.osgi.framework.AdminPermission", "<init>", "()V")));
        assertTrue(xref.containsKey(new Clazz.MethodDef(0,
        		"org.osgi.framework.AdminPermission", "<init>",
                "(Lorg/osgi/framework/Bundle;Ljava/lang/String;)V")));
        assertTrue(xref.containsKey(new Clazz.MethodDef(0,
                "org.osgi.framework.AdminPermission", "<init>",
                "(Ljava/lang/String;Ljava/lang/String;)V")));
        assertFalse(xref.containsKey(new Clazz.MethodDef(0,
                "org.osgi.framework.AdminPermission$1", "run",
                "()Ljava/lang/Object;")));
        assertFalse(xref.containsKey(new Clazz.MethodDef(0,
                "org.osgi.framework.AdminPermission", "createName",
                "(Lorg/osgi/framework/Bundle;)Ljava/lang/String;")));
    }
