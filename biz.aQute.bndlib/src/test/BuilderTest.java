...
//        assertEquals("100", s);
    ...
    public void testWab() throws Exception {
        ...
        Manifest m = jar.getManifest();
        assertNotNull(m);
        assertEquals( "WEB-INF/classes,WEB-INF/lib/asm.jar,WEB-INF/lib/easymock.jar", m.getMainAttributes().getValue("Bundle-ClassPath"));
    ...
    public void testIncludeResourceFromZipOneDirectoryOther() throws Exception {
        ...
        p.put("Include-Resource",
                "OPT-INF/test=@jar/osgi.jar!/org/osgi/service/event/**");
        bmaker.setProperties(p);
        Jar jar = bmaker.build();
        System.out.println("warnings: "
                + Processor.join(bmaker.getWarnings(), "\n"));
        ...
        assertNotNull(jar
                .getResource("OPT-INF/test/org/osgi/service/event/EventAdmin.class"));
    }
