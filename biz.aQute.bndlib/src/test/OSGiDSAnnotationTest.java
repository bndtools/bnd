...
public class OSGiDSAnnotationTest extends BndTestCase {
	...
	public void testBasic() throws Exception {
...

		{
			...
			Resource r = jar.getResource("OSGI-INF/test.OSGiDSAnnotationTest$Defaults.xml");
			assertNotNull(r);
			r.write(System.out);
			...
			// Test the defaults
			xt.assertAttribute("test.OSGiDSAnnotationTest$Defaults",
					"scr:component/implementation/@class");

			// Default must be the implementation class
			xt.assertAttribute("test.OSGiDSAnnotationTest$Defaults", "scr:component/@name");
		...
		}
		{
			...
			Resource r = jar.getResource("OSGI-INF/test.OSGiDSAnnotationTest$Explicit.xml");
			assertNotNull(r);
			r.write(System.out);
			XmlTester xt = new XmlTester(r.openInputStream(), "scr",
					"http://www.osgi.org/xmlns/scr/1.1.0");
			...
			// Test the defaults
			xt.assertAttribute("test.OSGiDSAnnotationTest$Explicit",
					"scr:component/implementation/@class");

			// Default must be the implementation class
			xt.assertAttribute("test.OSGiDSAnnotationTest$Explicit", "scr:component/@name");
