...
public interface Constants {
    ...
    String               options[]                                 = {
            BSN_FROM_WORKSPACE, BUILDPATH, BUMPPOLICY, CONDUIT, CLASSPATH,
            DEPENDSON, DONOTCOPY, EXPORT_CONTENTS, FAIL_OK, INCLUDE,
            INCLUDERESOURCE, MAKE, MANIFEST, NOEXTRAHEADERS, NOUSES, NOPE,
            PEDANTIC, PLUGIN, POM, REMOVEHEADERS, RESOURCEONLY, SOURCES,
            SOURCEPATH, SOURCES, SOURCEPATH, SUB, RUNBUNDLES, RUNPATH,
            RUNSYSTEMPACKAGES, RUNPROPERTIES, REPORTNEWER, UNDERTEST,
            TESTBUNDLES, TESTPACKAGES, TESTREPORT, VERBOSE, NOMANIFEST,
            DEPLOYREPO, RELEASEREPO, SAVEMANIFEST, RUNVM, VERSIONPOLICY_USES,
            VERSIONPOLICY, VERSIONPOLICY_IMPL, WAB, WABLIB        };
    ...
    String[]             BUNDLE_SPECIFIC_HEADERS                   = new String[] {
            ...
            NOMANIFEST, SIGNATURE_TEST, WAB, WABLIB                            };
    ...
    String               directives[]                              = {
            ...
            SIGN_PASSWORD_DIRECTIVE, COMMAND_DIRECTIVE, NOANNOTATIONS,
            LIB_DIRECTIVE
