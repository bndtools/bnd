...
public class RepositoryFeature extends RepositoryEntry implements Actionable {
	...
	protected Map<String, String> getProperties() {
		return Map.of(IdentityNamespace.CAPABILITY_TYPE_ATTRIBUTE, "org.eclipse.update.feature");
	}

	@Override
	protected boolean acceptResourceType(org.osgi.resource.Resource resource) {
		return resource.getCapabilities(IdentityNamespace.IDENTITY_NAMESPACE)
			.stream()
