...
public class DummyBundleContext implements BundleContext {
    ...
    public void addBundleListener(BundleListener arg0) {
        if (DEBUG)
            System.out.println("--- addBundleListener(BundleListener)");
    }

    public void addFrameworkListener(FrameworkListener arg0) {
        if (DEBUG)
            System.out.println("--- addFrameworkListener(FrameworkListener)");
    }

    public void addServiceListener(ServiceListener arg0) {
        if (DEBUG)
            System.out.println("--- addServiceListener(ServiceListener)");
    }

    public void addServiceListener(ServiceListener arg0, String arg1) throws InvalidSyntaxException {
        if (DEBUG)
            System.out.println("--- addServiceListener(ServiceListener, String)");
    }

    public Filter createFilter(String arg0) throws InvalidSyntaxException {
        if (DEBUG)
            System.out.println("--- createFilter(String)");
    ...
    public ServiceReference[] getAllServiceReferences(String arg0, String arg1) throws InvalidSyntaxException {
        if (DEBUG)
            System.out.println("--- getAllServiceReferences(String, String)");
        return null;
    }
    ...
    public Bundle getBundle(long id) {
        if (DEBUG)
            System.out.println("--- getBundle(" + id + ")");
    ...
    public String getProperty(String arg0) {
        if (DEBUG)
            System.out.println("--- getProperty(String)");
        return null;
    }

    public Object getService(ServiceReference arg0) {
        if (DEBUG)
            System.out.println("--- getService(ServiceReference)");
        return null;
    }

    public ServiceReference getServiceReference(String arg0) {
        if (DEBUG)
            System.out.println("--- getServiceReference(String)");
        return null;
    }

    public ServiceReference[] getServiceReferences(String arg0, String arg1) throws InvalidSyntaxException {
        if (DEBUG)
            System.out.println("--- getServiceReferences(String, String)");
        return null;
    }

    public Bundle installBundle(String arg0) throws BundleException {
        if (DEBUG)
            System.out.println("--- installBundle(String)");
        return null;
    }

    public Bundle installBundle(String arg0, InputStream arg1) throws BundleException {
        if (DEBUG)
            System.out.println("--- installBundle(String, InputStream)");
        return null;
    }
    ...
    public void removeBundleListener(BundleListener arg0) {
        if (DEBUG)
            System.out.println("--- removeBundleListener()");
    }

    public void removeFrameworkListener(FrameworkListener arg0) {
        if (DEBUG)
            System.out.println("--- removeFrameworkListener()");
    }

    public void removeServiceListener(ServiceListener arg0) {
        if (DEBUG)
            System.out.println("--- removeServiceListener()");
    }

    public boolean ungetService(ServiceReference arg0) {
        if (DEBUG)
            System.out.println("--- ungetService(ServiceReference)");
        return false;
    }
