...
public class CommandLineOptions {
	...
	/** The default output file, resolved with the default pretty setting */
	...
	/** the known bundles properties file */
	...
	/** The default override built-in known bundles mode */
	public static final boolean DEFAULT_OVERRIDE_BUILTIN_KNOWN_BUNDLES = false;

	/** The override built-in known bundles mode */
	...
	/** The repository name */
	@Option(name = "-t", metaVar = "%p%f", usage = "Resource URL template. Use %s for symbolic name, %v for version, %f for filename and %p for dirpath (default = "
	 ...
	 *             when the root URL is malformed
	 */
	@Option(name = "-d", metaVar = "file:///root/URL", usage = "Root URL " + "(default = the current directory)")
	public void setRootURL(URL rootURL) throws MalformedURLException {
	...
	@Option(name = "-l", metaVar = "file:license.html", usage = "License URL " + "(default = none)")
	URL licenseURL = null;
