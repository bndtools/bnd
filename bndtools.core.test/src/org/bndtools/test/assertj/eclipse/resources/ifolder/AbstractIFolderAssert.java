...
public abstract class AbstractIFolderAssert<SELF extends AbstractIFolderAssert<SELF, ACTUAL>, ACTUAL extends IFolder>
	extends AbstractIResourceAssert<SELF, ACTUAL> {

	protected AbstractIFolderAssert(ACTUAL actual, Class<?> selfType) {
