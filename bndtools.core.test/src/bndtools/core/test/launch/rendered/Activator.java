...
/**
 * Activator bridging the bnd launcher to a <em>rendered</em> Eclipse
 * workbench for SWTBot tests.
 *
 * @see RenderedLauncher
 */
...
class LauncherTracker extends ServiceTracker<Object, ServiceRegistration<ApplicationLauncher>> {
	...
	public ServiceRegistration<ApplicationLauncher> addingService(ServiceReference<Object> reference) {
		...
		return context.registerService(ApplicationLauncher.class, new RenderedLauncher(context), null);
	}
