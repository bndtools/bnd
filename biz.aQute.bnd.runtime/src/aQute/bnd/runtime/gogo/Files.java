...
import static aQute.bnd.runtime.gogo.Util.CWD;
...
public class Files {
	...
	public File cd(@Descriptor("automatically supplied shell session") CommandSession session,
		@Descriptor("target directory") String dir) throws IOException {
	...
	public File[] ls(@Descriptor("automatically supplied shell session") CommandSession session) throws IOException {
	...
	public File[] ls(@Descriptor("automatically supplied shell session") CommandSession session,
		@Descriptor("path with optionally wildcarded file name") String pattern) throws IOException {
